...
<strong>Important: To run this project, you need to fill in information in dwh.cfg file.
To fill in the information, you need the following: an AWS Redshift cluster and IAM role with S3 access privilege.<br><br>
## How to Run
